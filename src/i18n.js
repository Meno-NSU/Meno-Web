...
const translations = {
    ru: {
        ...
        consentBody: "Чтобы отвечать на ваши вопросы, Менон обрабатывает текст ваших сообщений. Выберите, можно ли использовать ваши диалоги для улучшения сервиса. Продолжая, вы принимаете документы ниже.",
        consentDocsIntro: "Документы:",
        consentAllowImprovement: "Разрешить улучшение и продолжить",
        consentServiceOnly: "Продолжить без улучшения",
        consentError: "Не удалось сохранить выбор. Попробуйте ещё раз.",
        legalLinkPrivacy: "Конфиденциальность",
        legalLinkTerms: "Условия",
        legalLinkConsent: "Согласие",
        legalLinksLabel: "Правовые документы",
    ...
    en: {
        ...
        consentBody: "To answer your questions, Meno processes the text of your messages. Choose whether your dialogues may be used to improve the service. By continuing you accept the documents below.",
        consentDocsIntro: "Documents:",
        consentAllowImprovement: "Allow improvement and continue",
        consentServiceOnly: "Continue without improvement",
        consentError: "Couldn't save your choice. Please try again.",
        legalLinkPrivacy: "Privacy",
        legalLinkTerms: "Terms",
        legalLinkConsent: "Consent",
