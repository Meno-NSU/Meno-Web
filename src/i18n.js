...
const translations = {
    ru: {
        ...
        consentModalTitle: "История диалогов",
        consentModalBody: "Диалоги сохраняются, чтобы вы могли вернуться к ним позднее. С вашего согласия их обезличенные версии также будут использоваться для внутренней проверки качества и улучшения Менона.",
        consentModalGrantPrefix: "Нажимая «Продолжить», вы разрешаете использование обезличенных версий всех ваших диалогов в соответствии с ",
        consentModalConsentLink: "Согласием на обработку персональных данных",
        consentModalGrantSuffix: ". Выбор можно всегда изменить в настройках.",
        consentModalPolicyLink: "Политика обработки персональных данных",
        consentModalDefer: "Не сейчас",
        consentModalContinue: "Продолжить",
        authConsentNoticePrefix: "Создавая аккаунт, вы принимаете",
        authConsentNoticeAnd: "и",
        ...
        privacyImprovementHint: "Тексты сообщений сохраняются и используются для улучшения сервиса.",
        privacyClearLabel: "История на этом устройстве",
        privacyClearHint: "Удаляет чаты, сохранённые локально в этом браузере.",
        privacyClearButton: "Очистить",
        privacyClearConfirm: "Точно очистить",
        privacyCancel: "Отмена",
        privacyDeleteLabel: "Удалить мои данные",
        privacyDeleteHint: "Удаляет аккаунт (если есть), все чаты и историю на сервере. Необратимо.",
    ...
    en: {
        ...
        consentModalTitle: "Conversation history",
        consentModalBody: "Your conversations are saved so you can return to them later. With your consent, their anonymized versions will also be used for internal quality review and to improve Meno.",
        consentModalGrantPrefix: "By choosing “Continue”, you allow the use of anonymized versions of all your conversations in accordance with the ",
        consentModalConsentLink: "Personal Data Processing Consent",
        consentModalGrantSuffix: ". You can change your choice anytime in settings.",
        consentModalPolicyLink: "Personal Data Processing Policy",
        consentModalDefer: "Not now",
        consentModalContinue: "Continue",
        authConsentNoticePrefix: "By creating an account, you accept the",
        authConsentNoticeAnd: "and",
        ...
        privacyImprovementHint: "Message text is stored and used to improve the service.",
        privacyClearLabel: "History on this device",
        privacyClearHint: "Removes chats saved locally in this browser.",
        privacyClearButton: "Clear",
        privacyClearConfirm: "Yes, clear",
        privacyCancel: "Cancel",
        privacyDeleteLabel: "Delete my data",
        privacyDeleteHint: "Deletes your account (if any), all chats and server history. Irreversible.",
