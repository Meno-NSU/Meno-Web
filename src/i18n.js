...
const translations = {
    ru: {
        ...
        consentModalGrantPrefix: "Нажимая «Продолжить», вы разрешаете использование обезличенных версий всех ваших диалогов для улучшения и развития Менона в соответствии с ",
        consentModalConsentLink: "Согласием на обработку персональных данных",
        consentModalGrantSuffix: ". Этот выбор всегда можно будет изменить в настройках.",
    ...
    en: {
        ...
        consentModalGrantPrefix: "By choosing “Continue”, you allow anonymized versions of all your conversations to be used to improve and develop Meno, in accordance with the ",
        consentModalConsentLink: "Personal Data Processing Consent",
        consentModalGrantSuffix: ". You can change this choice at any time in settings.",
