...
const translations = {
    ru: {
        ...
        consentBannerTitle: "Улучшение Менона",
        consentBannerText: "Можно использовать ваши диалоги, чтобы улучшать Менон? Тексты сообщений сохраняются только с вашего согласия.",
        consentBannerMore: "Подробнее",
        consentBannerAllow: "Разрешить улучшение",
        consentBannerDecline: "Не сейчас",
        consentBannerDismiss: "Закрыть",
        authConsentNoticePrefix: "Создавая аккаунт, вы принимаете",
        authConsentNoticeAnd: "и",
        inputConsentNoticePrefix: "Отправляя сообщение, вы принимаете",
    ...
    en: {
        ...
        consentBannerTitle: "Improving Meno",
        consentBannerText: "May we use your conversations to improve Meno? Message text is stored only with your consent.",
        consentBannerMore: "Learn more",
        consentBannerAllow: "Allow improvement",
        consentBannerDecline: "Not now",
        consentBannerDismiss: "Dismiss",
        authConsentNoticePrefix: "By creating an account, you accept the",
        authConsentNoticeAnd: "and",
        inputConsentNoticePrefix: "By sending a message, you accept the",
