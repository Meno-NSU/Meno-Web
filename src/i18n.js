...
const translations = {
    ru: {
        ...
        surveyNotYours: "Этот диалог принадлежит другому профилю — войдите в тот же аккаунт, чтобы сохранить ответ на опрос.",
        ...
        consentModalGrantPrefix: "Нажимая «Продолжить», вы отдельно соглашаетесь на использование всех ваших диалогов для внутреннего улучшения Менона. Для анализа берутся отдельные копии, очищенные от прямых идентификаторов. Подробнее — в ",
        ...
        consentModalContinue: "Продолжить",
        authConsentCheckboxPrefix: "Я даю согласие на обработку моих персональных данных на условиях ",
        authConsentCheckboxLink: "Согласия на обработку персональных данных сервиса «Менон»",
    ...
    en: {
        ...
        surveyNotYours: "This conversation belongs to another profile — sign in to that account to save your survey answer.",
        ...
        consentModalGrantPrefix: "By choosing “Continue”, you separately consent to all your conversations being used to improve Meno internally. Analysis uses separate copies stripped of direct identifiers. Details in the ",
        ...
        consentModalContinue: "Continue",
        authConsentCheckboxPrefix: "I consent to the processing of my personal data under the terms of the ",
        authConsentCheckboxLink: "Meno Personal Data Processing Consent",
